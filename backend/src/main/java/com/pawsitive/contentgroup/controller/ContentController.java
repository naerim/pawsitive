...
public class ContentController {
    ...
    public ResponseEntity<PageResponse<ContentDetailRes>> getContentList(Pageable pageable,
                                                                         @RequestParam(required = false)
                                                                         Integer categoryNo) {
        return ResponseEntity
            .status(OK)
            .body(new PageResponse<>(contentService.getContentList(pageable, categoryNo)));
    }
