...
public class CommunityController {
    ...
    @GetMapping
    @Operation(summary = "커뮤니티 전체 조회", description = "커뮤니티 <strong>전체 조회</strong>를 한다. 파라미터로 카테고리 번호가 넘어온다면 <strong>카테고리별 커뮤니티 목록을 조회</strong> 한다.",
        responses = {
    ...
    @Operation(summary = "커뮤니티 인기글 조회", description = "<strong>인기글 목록을 파라미터로 전달 받은 조회할 갯수만큼 조회</strong> 한다.",
        responses = {
    ...
    @GetMapping("/{boardNo}")
    @Operation(summary = "커뮤니티 상세 조회", description = "커뮤니티를 <strong>커뮤니티 고유번호</strong>로 <strong>상세 조회</strong> 한다.",
        responses = {
