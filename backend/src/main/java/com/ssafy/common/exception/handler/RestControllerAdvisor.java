...
import com.ssafy.api.exception.DuplicateIdException;
import com.ssafy.api.exception.InvalidPasswordException;
import com.ssafy.api.exception.UserNotFoundException;
import com.ssafy.api.exception.UserNotLoginException;
...
//  }
  ...
  public ResponseEntity<BaseResponseBody> ConflictException409(RuntimeException e) {
    ...
    return ResponseEntity
        .status(CONFLICT)
        .body(BaseResponseBody.of(CONFLICT, e.getMessage()));
  }
