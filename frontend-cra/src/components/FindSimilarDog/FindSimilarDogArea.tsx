...
import * as f from './_style/FindSimilarDogAreaStyle'
import { FindSimilarDogResultType } from '@/types/dog'

ChartJS.register(CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend)

const FindSimilarDogArea = () => {
  ...
  const [resultData, setResultData] = useState<FindSimilarDogResultType[]>([])
...
export default FindSimilarDogArea
